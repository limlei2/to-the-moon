  ...
  return (
    <nav className="dark:bg-black w-full z-20 top-0 start-0">
      <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
        ...
        <div className="flex">
          <a href="/login"><button type="button" className="border border-white text-white bg-black hover:bg-white hover:text-black transition focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-3xl text-lg px-6 py-2 text-center mx-2">Login</button></a>
          <a href="/register"><button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-3xl text-lg px-6 py-2 text-center mx-2">Get Started</button></a>
        </div>
      </div>
    </nav>
  )
